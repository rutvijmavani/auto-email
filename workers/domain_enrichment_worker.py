...
def _process_company(r, fein: str, petition_count: int, trigger: str = "enrichment",
    ...
    try:
        ...
        # â”€â”€ Step 2: Phase 3 — career path probe (always runs) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Step 3: Phase 6 — career page ATS scan (only if Phase 3 found nothing) â”€â”€
        p6_platform = None
        p6_slug     = None
        p6_written  = False
        if not p3_platform:
