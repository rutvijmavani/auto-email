...
def init_db():
    ...
    c.execute("""
        CREATE TABLE IF NOT EXISTS uscis_h1b_petitions (
            ...
            state                           TEXT,
            zip                             TEXT,
            new_employment_approval         INTEGER NOT NULL DEFAULT 0,
            new_employment_denial           INTEGER NOT NULL DEFAULT 0,
            continuation_approval           INTEGER NOT NULL DEFAULT 0,
            continuation_denial             INTEGER NOT NULL DEFAULT 0,
            change_same_employer_approval   INTEGER NOT NULL DEFAULT 0,
            change_same_employer_denial     INTEGER NOT NULL DEFAULT 0,
            new_concurrent_approval         INTEGER NOT NULL DEFAULT 0,
            new_concurrent_denial           INTEGER NOT NULL DEFAULT 0,
            change_of_employer_approval     INTEGER NOT NULL DEFAULT 0,
            change_of_employer_denial       INTEGER NOT NULL DEFAULT 0,
            amended_approval                INTEGER NOT NULL DEFAULT 0,
            amended_denial                  INTEGER NOT NULL DEFAULT 0,
            ingested_at                     TIMESTAMPTZ NOT NULL DEFAULT NOW(),
            UNIQUE (employer_name, tax_id, fiscal_year, naics_code, city, zip)
        )
    """)
    ...
    c.execute("""
        ALTER TABLE h1b_ats_discovery
        ADD COLUMN IF NOT EXISTS kg_mid TEXT
    """)
    c.execute("""
        ALTER TABLE h1b_ats_discovery
